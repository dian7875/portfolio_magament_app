...
import { UseExecuteEducationAction } from "../../composables/executeAction";
...
const { mutate, isPending } = UseExecuteEducationAction();
...
const formId = computed(() => `${props.action}-education-form`);
