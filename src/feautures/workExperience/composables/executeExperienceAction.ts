...
export const UseExecuteExperienceAction = () => {
...
> = {
  delete: (id) => WorkExperiencesService.removeExperience(id),
  hide: (id) => WorkExperiencesService.hideExperience(id),
  restore: (id) => WorkExperiencesService.restoreExperience(id),
};
